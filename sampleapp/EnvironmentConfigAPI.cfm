ý<html>
	...
	<body>
		...
		<cfscript>
			...
			user = structNew();
			user["id"]			= createUUID();
			user["name"] 		= "Kavitha Christo";
			user["email"]		= "kavitha.nelson@colytsis.com";
			user["loginName"]	= "knelson";
...
oUser.getMemento();
			...
			");	
			writeDump(var:oUser.getMemento(),abort:false,label:"oUser: Kavitha Christo");
